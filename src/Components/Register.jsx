    ...
    <div>
      ...
      <form onSubmit={handleSubmitForm} className="">
        ...
        <fieldset className="fieldset">
          ...
          <button className="btn bg-[#0E7A81] text-white mt-4">Register</button>
        </fieldset>
      </form>
      <h1 className="pt-3">All ready have an Account ? <Link className="underline text-blue-700" to="/login">Login</Link> </h1>
    </div>
        </div>
    </div>
  )
